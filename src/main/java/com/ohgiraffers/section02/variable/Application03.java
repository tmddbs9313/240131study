...
public class Application03 {
    public static void main(String[] args) {
        ...
        /*필기.
        *  변수의 명명 규칙
        *  변수이 이름을 지을 때 아무렇게나 짓는 것이 아닌 정해진 규칙이 있다.
        ...
        *     1-4. 변수명은 숫자로 시작할 수 없다. (시작만 할 수 없고 숫자를 섞어서 사용한는 것은 가능.)
        *     1-5. 특수기호는 '-', '$'만 사용 가능하다.
        *  2. 컴파일 에러를 발생시키지는 않지만 개발자들끼리의 암묵적인 규칙
        *     2-1. 변수명의 길이 제한은 없다. (하지만 적당히 해야함ㅇㅇ)
        ...
        *     2-5. 변수 안에 저장된 값ㅇㅣ 어떤 의미를 가지는지 알 수 있도록 이름을 짓는다
...
//        int int = 1;
        ...
        int Age = 20;  //대소문자 차이로 다른언어가 됨.

        /*목차. 1-4. 변수명은 숫자로 시작할 수 없다.*/
//        int 1age = 20;  //숫자는 시작하면 오류가 발생한다.
        int age1 = 20;

        /*목차. 1-5. 특수기호는 '-' 와 '$'만 사용이 가능하다.*/
        int _age = 20;
        int $harp = 20;
//        int s@adaad = 20;
        ...
        int sdksfldsjfksjfkdsjlfkjdkjkwjkjflwkfjldksfsa;

        /*목차 2-2. 변수명이 합성어로 이루어진 경우 첫 단어는 소문자, 두번째 시작단어는 대문자로 시작한다.*/
        ...
        /*목차. 2-4. 한글로 변수명을 짓는것이 가능하지만, 권장하지 않는다.*/
        int 나이;

        /*목차 .2-5. 변수안에 저장된 값이 어떤 의미를 가지는 지 명확하게 표현 하도록 한다.*/
        String s;
        String name;  //문자열 형태의 이름이 저장되겠구나~ 하는 의도가 파악.
        ...
        String goHome;  //가능하긴 하지만 가급적으로 명사형.
